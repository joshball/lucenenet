...
namespace Lucene.Net.Search.Highlight
{
    ...
    public class QueryScorer : IScorer
    {
        ...
        {
            fieldWeightedSpanTerms = new Dictionary<string, WeightedSpanTerm>(weightedTerms
                .Length);
        ...
        public virtual float GetTokenScore()
        {
            ...
            var score = weightedSpanTerm.GetWeight();
        ...
        {
            var qse = NewTermExtractor(defaultField);
            ...
            {
                fieldWeightedSpanTerms = qse.GetWeightedSpanTermsWithScores(query, tokenStream
                    , field, reader);
            }
        ...
        ///     against a
        ///     <see cref="Lucene.Net.Index.Memory.MemoryIndex">
        ///         Lucene.Net.Index.Memory.MemoryIndex
        ///     </see>
        ///     <see cref="Lucene.Net.Index.IndexReader">
        ///         Lucene.Net.Index.IndexReader
        ///     </see>
        ...
        ///     <see cref="Lucene.Net.Analysis.CachingTokenFilter">
